(function(RTC, $){
    ...
    RTC.audioElement = document.querySelector('#myAudio');
    RTC.canvasElement = document.querySelector('#canvas');
    ...
    RTC.setupAudioNodes=function(stream) {
        RTC.sourceNode     = RTC.audioContext.createMediaStreamSource(stream);
    ...
    RTC.openMedia = function() {
        ...
        navigator.mediaDevices.getUserMedia(mediaConstraints, handleSuccess, handleError);

    }

    function handleSuccess(stream) {

        RTC.audioElement.srcObject = stream;
        RTC.setupAudioNodes(stream);
